...
console.log("Quantidade de homens cadastrados: "+qtdDeHomens)
console.log("Quantidade de mulheres cadastradas: "+qtdDemulheres)
console.log("Mulheres com nota acima de 7: "+mulheresComMaiorNota)
